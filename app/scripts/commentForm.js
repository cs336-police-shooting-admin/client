...
module.exports = React.createClass({
  ...
  handleSubmit: function(e) {
    ...
    if (!author || !date || !manner_of_death || !armed || !gender || !race
      || !city || !state || !signs_of_mental_illness || !threat_level ||
      !flee || !body_camera) {
      return;
    }
    // TODO: send request to the server
    this.props.onCommentSubmit({author: author, date: date, manner_of_death: manner_of_death,
    ...
    this.setState({author: '', date: '', manner_of_death: '', armed: '',
          age: '', gender: '', race: '', city: '', state: '', 
